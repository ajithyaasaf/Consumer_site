        ...
        <div className="flex max-lg:flex-col gap-y-10">
          ...
          <div className="w-full lg:w-1/3 lg:pl-[55px]">
            <div className="search-block rounded-lg bg-surface h-[50px] relative">
              <input
                className="rounded-lg bg-surface w-full h-full pl-4 pr-12"
                type="text"
                placeholder="Search"
              />
            ...
            <div className="cate-block md:mt-10 mt-6">
              ...
              <div className="list-nav mt-4">
                {[
                  ...
                  <div
                    key={item}
                    className={`nav-item rounded-lg flex items-center justify-between p-3 cursor-pointer text-button text-secondary capitalize ${
            ...
            <div className="tags-popular-block md:mt-10 mt-6">
              ...
              <div className="list-tag mt-4 flex flex-wrap gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className={`caption2 py-2 px-4 rounded-2xl hover:bg-black hover:text-white duration-300 cursor-pointer ${
                      item === tag ? "bg-black text-white" : "bg-surface"
                    }`}
